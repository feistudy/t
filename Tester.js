...
natural.BayesClassifier.load('Classifier.json', null, (error, classifier) => {
  ...
  console.log(`${classifier.classify('CRA Statement on US News and World Report')}, Other`);
  console.log('-----');
  ...
  console.log(`${classifier.classify('This Is Why Your Passive-Aggressive Office Note Didn’t Work')}, Other`);
  console.log(`${classifier.classify('')}, Other`);
});
